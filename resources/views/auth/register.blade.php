    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="col-md-6">
            <div class="card-body text-center">
                ...
                <!-- フォーム -->
                <form method="POST" action="{{ route('registernew') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <!-- プロフィール画像アップロード -->
                    <label for="profile_photo" class="block text-left font-semibold mb-1 mt-3">Profile Image</label>
                    <input id="profile_photo" type="file" class="form-control mb-3 @error('profile_photo') is-invalid @enderror" name="profile_photo" accept="image/*">
                    @error('profile_photo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
