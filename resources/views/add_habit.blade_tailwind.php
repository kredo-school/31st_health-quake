    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <div class="grid grid-cols-2 gap-4 mt-4">
            <div class="bg-blue-200 rounded-lg p-2 shadow">
                <img src="{{ asset('images/dont_smoke.png') }}" alt="Don't smoke" class="w-full rounded mb-2">
                <p class="text-center font-semibold">Don’t smoke</p>
            </div>
            <div class="bg-purple-200 rounded-lg p-2 shadow">
                <img src="{{ asset('images/glass_water.png') }}" alt="Glass of water" class="w-full rounded mb-2">
                <p class="text-center font-semibold">Glass of water</p>
            </div>
            <div class="bg-green-200 rounded-lg p-2 shadow">
                <img src="{{ asset('images/get_outside.png') }}" alt="Get outside" class="w-full rounded mb-2">
                <p class="text-center font-semibold">Get outside</p>
            </div>
            <div class="bg-pink-200 rounded-lg p-2 shadow">
                <img src="{{ asset('images/morning_exercise.png') }}" alt="Morning exercise" class="w-full rounded mb-2">
                <p class="text-center font-semibold">Morning exercise</p>
            </div>
        </div>
    </div>
</body>
